...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://better-to-do-list/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://better-to-do-list/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://better-to-do-list/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://better-to-do-list/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i);\n\n//# sourceURL=webpack://better-to-do-list/./node_modules/uuid/dist/esm-browser/regex.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _regex_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./regex.js */ \"./node_modules/uuid/dist/esm-browser/regex.js\");\n\n\nfunction validate(uuid) {\n  return typeof uuid === 'string' && _regex_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].test(uuid);\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (validate);\n\n//# sourceURL=webpack://better-to-do-list/./node_modules/uuid/dist/esm-browser/validate.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"appLogic\": () => (/* binding */ appLogic)\n/* harmony export */ });\n/* harmony import */ var _ToDo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ToDo */ \"./src/ToDo.js\");\n/* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project */ \"./src/project.js\");\n/* harmony import */ var _displayControl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./displayControl */ \"./src/displayControl.js\");\n/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! uuid */ \"./node_modules/uuid/dist/esm-browser/v4.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\n\n\nconst appLogic = (() => {\n\n    const allProjects = [];\n    let currentProject = (0,_project__WEBPACK_IMPORTED_MODULE_1__.Project)(\"Inbox\", [], \"inbox\");\n\n    function startUp(){\n        allProjects.push(currentProject);\n        const Today1 = createProject(\"Today\", []);  \n        createToDo(\"Watch Squid Game with Heli\", null, null, null, null, Today1);\n        createToDo(\"Watch Squid Game with Heli\", null, null, null, null, Today1);\n        createToDo(\"Watch Squid Game with Heli\", null, null, null, null, Today1);\n        createToDo(\"Watch Squid Game with Heli\", null, null, null, null, Today1);\n        createToDo(\"Watch Squid Game with Heli\", null, null, null, null, Today1);\n        createToDo(\"Watch Squid Game with Heli\", null, null, null, null, Today1);\n    }\n\n    function deleteToDoByID(id){\n        for(let i=0;i<currentProject.getToDos().length;i++){\n            if (currentProject.getToDos()[i].getId() == id){\n                currentProject.deleteToDo(currentProject.getToDos()[i]);\n            }\n        }\n        _displayControl__WEBPACK_IMPORTED_MODULE_2__.displayControl.render();\n    }\n\n    function createToDo(title, description, dueDate, priority, notes, project){\n        const newToDo = (0,_ToDo__WEBPACK_IMPORTED_MODULE_0__.ToDo)(title, description, dueDate, priority, notes, \"b\" + (0,uuid__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(), project);\n        project.addToDo(newToDo);\n        _displayControl__WEBPACK_IMPORTED_MODULE_2__.displayControl.render();\n    }\n\n    function createProject(name, todos){\n        const newProject = (0,_project__WEBPACK_IMPORTED_MODULE_1__.Project)(name, todos, \"a\" + (0,uuid__WEBPACK_IMPORTED_MODULE_4__[\"default\"])());\n        allProjects.push(newProject);\n        _displayControl__WEBPACK_IMPORTED_MODULE_2__.displayControl.render();\n        return newProject;\n    }\n\n    function getCurrentProject(){\n        for(let i = 0; i < allProjects.length; i++){\n            if(allProjects[i].getId() == _displayControl__WEBPACK_IMPORTED_MODULE_2__.displayControl.getCurrentProjectId()){\n                currentProject = allProjects[i]\n            }\n        }\n        return currentProject;\n    }\n\n    return { getCurrentProject, startUp, currentProject, allProjects, createToDo, createProject, deleteToDoByID}\n})();\n\n\nappLogic.startUp();\n\n \n\n//# sourceURL=webpack://better-to-do-list/./src/index.js?");
